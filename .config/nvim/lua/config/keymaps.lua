...
-- vim.keymap.set("n", "<LeftMouse>", "", { desc = "Disable left mouse click in normal mode." })
-- vim.keymap.set("i", "<LeftMouse>", "", { desc = "Disable left mouse click in insert mode." })
-- vim.keymap.set("v", "<LeftMouse>", "", { desc = "Disable left mouse click in visual mode." })
-- vim.keymap.set("n", "<2-LeftMouse>", "", { desc = "Disable double left mouse click in normal mode." })
-- vim.keymap.set("i", "<2-LeftMouse>", "", { desc = "Disable double left mouse click in insert mode." })
-- vim.keymap.set("v", "<2-LeftMouse>", "", { desc = "Disable double left mouse click in visual mode." })
-- vim.keymap.set("n", "<LeftDrag>", "", { desc = "Disable dragging in normal mode." })
-- vim.keymap.set("i", "<LeftDrag>", "", { desc = "Disable dragging in insert mode." })
-- vim.keymap.set("v", "<LeftDrag>", "", { desc = "Disable dragging in visual mode." })
